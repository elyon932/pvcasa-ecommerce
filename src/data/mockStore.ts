...
export const dashboardMetrics: DashboardMetrics = {
  ...
  ordersTrendPercent: 8.7,
  revenueSeries: [
    { label: "Seg", revenueInCents: 2864000, orders: 58 },
    { label: "Ter", revenueInCents: 3189000, orders: 64 },
    { label: "Qua", revenueInCents: 2956000, orders: 61 },
    { label: "Qui", revenueInCents: 3528000, orders: 72 },
    { label: "Sex", revenueInCents: 4212000, orders: 86 },
    { label: "Sab", revenueInCents: 4765000, orders: 98 },
    { label: "Dom", revenueInCents: 3342000, orders: 77 },
  ],
  trafficSources: [
    { label: "Busca orgânica", visits: 6999, share: 38 },
    { label: "Instagram", visits: 4973, share: 27 },
    { label: "Facebook", visits: 3131, share: 17 },
    { label: "Outros", visits: 2026, share: 11 },
    { label: "Whatsapp", visits: 1289, share: 7 },
  ],
  orderStatusBreakdown: [
    { status: "PROCESSING", label: "Preparação", count: 184 },
    { status: "PAID", label: "Pagos", count: 126 },
    { status: "DELIVERED", label: "Entregues", count: 110 },
    { status: "SHIPPED", label: "Enviados", count: 96 },
    { status: "CANCELED", label: "Cancelados", count: 14 },
  ],
  categorySales: [
    { label: "Cama", quantity: 184, share: 36 },
    { label: "Mesa", quantity: 126, share: 25 },
    { label: "Banho", quantity: 94, share: 18 },
    { label: "Decor", quantity: 68, share: 13 },
    { label: "Infantil", quantity: 44, share: 8 },
  ],
  bestSellers: [
  ...
  topCustomers: [
    { name: "Sem dados", orders: 0, totalInCents: 0 },
    { name: "Sem dados", orders: 0, totalInCents: 0 },
    { name: "Sem dados", orders: 0, totalInCents: 0 },
    { name: "Sem dados", orders: 0, totalInCents: 0 },
    { name: "Sem dados", orders: 0, totalInCents: 0 },
