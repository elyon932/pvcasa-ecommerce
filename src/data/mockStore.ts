...
export const dashboardMetrics: DashboardMetrics = {
  ...
  trafficSources: [
    { label: "Busca orgânica", visits: 7540, share: 41 },
    { label: "Instagram", visits: 5158, share: 28 },
    { label: "Direto", visits: 3316, share: 18 },
    { label: "Indicações", visits: 2406, share: 13 },
  ],
  ...
  operationalAlerts: [
    { label: "Checkout saudável", value: "98,6%", tone: "success" },
    { label: "Produtos com baixo estoque", value: "4", tone: "warning" },
    { label: "SLA médio de preparo", value: "1,8 dia", tone: "neutral" },
  ],
  bestSellers: [
